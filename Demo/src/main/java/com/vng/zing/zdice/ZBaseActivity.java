	...
	public void getProfile(){
		...
		ZaloSDK.Instance.getProfile(this, new ZaloOpenAPICallback() {
			...
			public void onResult(JSONObject arg0) {
				Log.i("debuglog", "get profile: " + arg0);
				try{
					if (arg0.getInt("error") == 0){
						JSONObject data = arg0.getJSONObject("result");
						mUserData = new UserData();
						mUserData.setImgLink(data.getString("avatar"));
						mUserData.setUserName(data.getString("displayName"));
						mUserData.setUserId(data.getString("userId"));
					}
				}
				catch(Exception ex){
