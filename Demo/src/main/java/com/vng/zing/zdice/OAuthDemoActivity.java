...
//			showMainActivity();
    ...
    public void vietnamclick(View v){
        HomeActivity.changeLanguage(this, "vi");
        ZaloSDK.Instance.setLanguageSDK(this, "vi");
    }

    public void myanmarclick(View v){
        HomeActivity.changeLanguage(this, "my");
        ZaloSDK.Instance.setLanguageSDK(this, "my");
    }

    public void englishclick(View v){
        HomeActivity.changeLanguage(this, "en");
        ZaloSDK.Instance.setLanguageSDK(this, "en");
    }
